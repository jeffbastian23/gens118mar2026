...
import { Database, LayoutDashboard, Building2, Home, LogOut, Settings, Headphones } from "lucide-react";
import AktivasiCortaxDatabase from "@/components/AktivasiCortaxDatabase";
import AktivasiCortaxDashboard from "@/components/AktivasiCortaxDashboard";
import SatkerCortaxDashboard from "@/components/SatkerCortaxDashboard";
...
export default function AktivasiCortaxPage() {
        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 md:py-6">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-xs sm:text-sm md:text-lg lg:text-xl xl:text-2xl font-bold leading-tight">Aktivasi Cortax</h1>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          <TabsList className="grid w-full max-w-lg grid-cols-3">
            ...
            <TabsTrigger value="satker" className="flex items-center gap-2">
          ...
          <TabsContent value="dashboard">
            <AktivasiCortaxDashboard />
          </TabsContent>

          <TabsContent value="satker">
            <SatkerCortaxDashboard />
          </TabsContent>

          <TabsContent value="database">
            <AktivasiCortaxDatabase />
          </TabsContent>
        </Tabs>
      </div>
    </div>
