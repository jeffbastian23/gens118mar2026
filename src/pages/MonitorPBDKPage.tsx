...
import { Database, LayoutDashboard, Home, LogOut, Settings, Headphones } from "lucide-react";
import MonitorPBDKDatabase from "@/components/MonitorPBDKDatabase";
import MonitorPBDKDashboard from "@/components/MonitorPBDKDashboard";
...
export default function MonitorPBDKPage() {
        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4 md:py-6">
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div>
                <h1 className="text-xs sm:text-sm md:text-lg lg:text-xl xl:text-2xl font-bold leading-tight">Monitor PBDK</h1>
